                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="<?= base_url('login/daftar'); ?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Masukkan namamu" value="<?= set_value('username'); ?>">
                                            <?= form_error('username', '<small class="text-danger pl-3">', '</small>'); ?>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="password" name="password" placeholder="Masukkan kata sandimu">
                                            <?= form_error('password', '<small class="text-danger pl-3">', '</small>'); ?>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="password" name="passconf" placeholder="Ayo ulangi sekali lagi">
                                    ...
                                    <div class="text-center">
                                        <a class="medium" style="color: grey;" href="<?= base_url('login'); ?>">Sudah punya buku? Ayo kita buka sekarang!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
